...
// PowerBI callback 
export const SET_PBI_CALLBACK = 'SET_PBI_CALLBACK';

// Cog data set
export const SET_COG_DATA = 'SET_COG_DATA';

// xy label decision array set
export const SET_XY_LABEL_DECISON_ARRAY = 'SET_XY_LABEL_DECISON_ARRAY';
